  ...
  return (
    <div className="contact-us-container" id="Contact Us">
      ...
      <div className="socials">
          <a href="https://instagram.com"><InstagramIcon fontSize='large' style={{ color: '#B8DE29' }}/></a>
          <a href="https://linkedin.com"><LinkedInIcon fontSize='large' style={{ color: '#B8DE29' }}/></a>
      ...
      <div className="contact-us-flex">
        <div className="contact-us-item">
          <h2>Email</h2>
          <p className='mail-contact-us'> <MailOutlineIcon/>&nbsp;abc@gmail.com</p>
          {/* <h2>Phone</h2>
